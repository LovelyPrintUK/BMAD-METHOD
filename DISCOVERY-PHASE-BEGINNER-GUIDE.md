# 🚀 Discovery Phase (Phase 1) - Beginner's Guide

**Welcome!** This guide will help you understand the Discovery process and get started with your first project using BMAD-METHOD.

---

## What is the Discovery Phase?

Discovery Phase (Phase 1) is like having a conversation with yourself about your project idea **before** you start building. It helps you:

- **Clarify your idea** - Turn vague thoughts into concrete plans
- **Understand the problem** - What are you really trying to solve?
- **Define your users** - Who will use this and why?
- **Scope your MVP** - What features do you actually need for the first version?

**Important:** Discovery is **100% OPTIONAL**. If you already know what you want to build, you can skip straight to Phase 2 (Planning).
...
- You need to convince others (stakeholders, partners)
...
## The 5 Discovery Workflows (Simplified)
...
- MVP features (what goes in version 1?)
- Success metrics (how will you know it works?)

**Time:** 30-60 minutes

**Simple explanation:** Think of it as writing a "pitch document" for your idea - but the AI helps you figure out what to say by asking smart questions.
...
**Simple explanation:** Like having 3 different architects give you 3 different designs for your house, then helping you pick the best one.
...
- **User** - Who are my customers and what do they need?

**Best for:** When you need data to make decisions

**Simple explanation:** Like hiring a research assistant to gather information about competitors, market size, or technology options.
...
**Simple explanation:** Learning the rules and trends of a specific field before you build something in it.
...
**Simple explanation:** Like a game design jam session with an AI that knows creative ideation methods.
...
4. **Move to Phase 2** when you're ready
...
## 📁 Where to Save Your Discovery Work
...
your-project/
  docs/
    discovery/
      product-brief.md          ← Your main vision document
      market-research.md        ← If you did research
      brainstorming-notes.md    ← If you brainstormed
```

**Tip:** These documents will be used in Phase 2 when you create your PRD!
...
- Skip defining WHO this is for (affects everything else)

---

## Common Questions

**Q: Do I have to do Discovery?**
A: Nope! It's optional. If you're clear on what to build, skip to Phase 2.

**Q: Can I come back and update my Discovery docs later?**
A: Yes! They're living documents. Update as you learn.

**Q: What if I don't know my market size or competitors?**
A: That's OK for hobby projects. For business projects, run the Research workflow.

**Q: How detailed should my Product Brief be?**
A: Hobby project: 2-3 pages. Startup: 5-7 pages. Enterprise: 10+ pages. Match it to your needs.

**Q: I'm stuck on a question. What do I do?**
A: Make your best guess and mark it as an assumption. You can validate later.

---

## Next Steps After Discovery

Once you've completed Discovery (or decided to skip it):

1. **Phase 2: Planning** - Create your PRD (Product Requirements Document) or tech-spec
2. **Phase 3: Architecture** - Design your system (for larger projects)
3. **Phase 4: Implementation** - Actually build it!

See `/src/modules/bmm/docs/quick-start.md` for the complete workflow.

---

## Example: Simple Product Brief

Here's what a minimal Product Brief looks like:
...
🤖 **AI-Guided:** Load the Analyst agent → run `*product-brief` workflow

✍️ **Manual:** Create `docs/discovery/product-brief.md` → answer the key questions

🏃 **Skip Discovery:** Go straight to Phase 2 PRD workflow

---

**Remember:** Discovery is about clarity, not perfection. Spend enough time to get clear, then move forward. You can always come back and refine!
